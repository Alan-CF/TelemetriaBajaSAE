...
void loop()  // Start of loop:
{
  ...
  float currTime = float(millis()) / 1000;
  Serial.print(currTime); //Tiempo
  Serial.print(",");
  Serial.print(0); //Temperatura
  Serial.print(",");
  Serial.print(float(average)/1000); //RPM x 1000
  Serial.print(",");
  Serial.print(0); //Giroscopio Vert
  Serial.print(",");
  Serial.print(0); //Giroscopio Lat
  Serial.print(",");
  Serial.print(0); //Delanteero Derecho
  Serial.print(",");
  Serial.print(0); //Delantero Isquierdo
  Serial.print(",");
  Serial.print(0); //Trasero Derecho
  Serial.print(",");
  Serial.println(0); //Trasero Isquierdo
